  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 pt-28 pb-20 sm:pt-36">
        {/* Badge */}
        <div className="animate-fade-in animation-delay-100 inline-flex items-center gap-2 rounded-full glass-sm border border-indigo-500/20 px-4 py-1.5 mb-8">
        ...
        {/* Heading */}
        <h1 className="font-display animate-slide-up animation-delay-200 text-5xl sm:text-6xl md:text-7xl font-bold leading-[1.05] tracking-tight">
        ...
        {/* Subtitle */}
        <p className="animate-slide-up animation-delay-300 mt-6 max-w-xl text-lg text-zinc-400 leading-relaxed">
        ...
        {/* CTA buttons */}
        <div className="animate-slide-up animation-delay-400 mt-10 flex flex-wrap gap-4">
          <a
            href="#projects"
            className="btn-primary relative z-0 inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-base font-semibold text-white"
          >
          ...
          <a
            ...
            download
            className="btn-secondary inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-base font-semibold text-zinc-200"
          >
        ...
        {/* Social links */}
        <div className="animate-fade-in animation-delay-500 mt-10 flex items-center gap-5">
          <a
        ...
        {/* Stats row */}
        <div className="animate-slide-up animation-delay-600 mt-16 grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-md">
          {[
